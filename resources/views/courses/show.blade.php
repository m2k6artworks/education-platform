            ...
            @if($isEnrolled)
                ...
                <div class="p-8 pb-4">
                    ...
                    @if($mainContent && $mainContent->content_type === 'video')
                        <div class="rounded-xl overflow-hidden mb-6 bg-black">
                            <video controls class="w-full aspect-video">
                                <source src="{{ Storage::url($mainContent->content) }}" type="video/mp4">
                    ...
                    <!-- Instructors (contoh, bisa diisi dinamis sesuai data) -->
                    <div class="flex flex-wrap gap-4 mb-8">
                        <div class="flex items-center gap-3">
                            <div class="w-12 h-12 rounded-full bg-gray-700 flex items-center justify-center text-xl font-bold">A</div>
                            <div>
                                <div class="text-xs text-gray-400">HR Business Manager, at Microsoft</div>
                                <div class="font-semibold">Ademola Odusanya</div>
                            </div>
                        </div>
                        <div class="flex items-center gap-3">
                            <div class="w-12 h-12 rounded-full bg-gray-700 flex items-center justify-center text-xl font-bold">D</div>
                            <div>
                                <div class="text-xs text-gray-400">Head of HR Edu-tech company SREDA</div>
                                <div class="font-semibold">Daria Filipchenko</div>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="bg-white px-8 pt-4 rounded-b-2xl shadow-inner">
    <div class="flex border-b border-gray-200 mb-4">
        <button id="tab-overview"
            class="py-2 px-4 font-semibold border-b-2 transition-colors duration-200
